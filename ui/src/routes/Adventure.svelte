            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="alert alert-dismissible alert-danger">
                  ...
                  />
                  <strong>Pass auf!</strong> Deine Lebenspunkte {gameSession
                    .character.endurance.value} sind Gefährlich niedrig.
                </div>
              </div>
            </div>
          {/if}
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div
                      ...
                      style="max-height: 150px; margin-right:auto;"
                    >
                      {#if gameSession.character.endurance.value < 25}
                        <div class="alert alert-dismissible alert-danger">
                          <button
                            ...
                            data-bs-dismiss="alert"
                          />
                          <strong>Pass auf!</strong>
                          <a href="#" class="alert-link"
                            >deine Lebenspunkte sind Gefährlich niedrig</a
                          >
                        </div>
                      {/if}
                      <p>Kampflog</p>
